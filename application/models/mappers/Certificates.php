...
/**
 * sql mapper of Certificates
 *
 * @author coola
 */
class Application_Model_Mapper_Certificates extends Application_Model_Mapper_Abstract {
     ...
     * @var string
     */
    protected $_dbTable_class = 'Application_Model_DbTable_Certificates';
     ...
     * @var string
     */
    protected $_dbModel_class = 'Application_Model_Certificates';
